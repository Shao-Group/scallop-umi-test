...
def plot_cells(match, pre):
    ...
    plt.savefig('./Mouse-Fibroblast/figure/transcripts_num_multiExon.pdf', bbox_inches = 'tight')
    ...
    ax.set(ylim=[0, 75],xlim=[1,370])
    ax.legend(loc='upper left', fontsize=22)
    plt.xticks(np.arange(1, 370.0, 80), fontsize=30, horizontalalignment='center')
    plt.yticks(np.arange(0, 75.0, 20), fontsize=30)
    plt.yticks(rotation = 90)
    ...
    plt.savefig('./Mouse-Fibroblast/figure/precision_multiExon.pdf', bbox_inches = 'tight')
...
def plot_scatter(scallop2_match, stringtie2_match, scallop_match, class2_match, scallop2_pre, stringtie2_pre, scallop_pre, class2_pre):
    ...
    plt.savefig('./Mouse-Fibroblast/figure/scatter_multiExon.pdf', bbox_inches = 'tight')
    return None
