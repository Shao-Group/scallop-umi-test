...
import plots_Mouse_Fibroblast as pm
...
def plot_adjusted(scallop2_match, stringtie2_match, scallop_match, class2_match, scallop2_pre, stringtie2_pre, scallop_pre, class2_pre):
    ...
    for i in range(6):
        ...
        if(i<3):
            filename = "./HEK293T/figure/adjusted_cell_pre" + flist[i] + ".pdf"
        else:
            filename = "./Mouse-Fibroblast/figure/adjusted_cell_pre" + flist[i] + ".pdf"
    ...
    figure_name = './HEK293T/figure/adjusted_pre.pdf'
    plt.savefig(figure_name, bbox_inches='tight')
    ...
    figure_name = './Mouse-Fibroblast/figure/adjusted_pre.pdf'
    plt.savefig(figure_name, bbox_inches='tight')
