...
def load_data(tool, t_type):
    ...
    scallop2 = np.zeros([192,16])
    
    dirPath = './HEK293T/scallop2/scallop2-'+ t_type + '/'
...
def plot_bar(nf_ave, nf_sd, f_ave, f_sd):
    ...
    ax.set(ylim=[0, 70])
    ax.set(xlim=[-0.6, 8.5])
    plt.yticks(np.arange(0, 71, 35), fontsize=16)
    ...
    plt.text(-2.5,70,idx, fontsize=18)
    figure_name = "./HEK293T/figure/HE-fragments.pdf"
