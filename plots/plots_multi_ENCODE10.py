...
def load_data(tool):
    ...
    file1 = dirPath + 'hisat.' + tool + '.numMultiTranscripts'
    file2 = dirPath + 'hisat.' + tool + '.numMatchIntronChain.results'
    file3 = dirPath + 'star.' + tool + '.numMultiTranscripts.results'
    file4 = dirPath + 'star.' + tool + '.numMatchIntronChain.results'
...
def plot_sample(hmatch, hpre, smatch, spre):
    ...
    for ii in range(1,11):
        ...
        file1 = './ENCODE10/scallop2/' + samples[i] + '.hisat.me.roc-cor'
        file2 = './ENCODE10/scallop2/' + samples[i] + '.hisat.me.roc-pre'
        file3 = './ENCODE10/scallop2/' + samples[i] + '.star.me.roc-cor'
        file4 = './ENCODE10/scallop2/' + samples[i] + '.star.me.roc-pre'
	...
	if(ii == 10 or ii == 8 or ii == 5):
        ...
        figure_name = './ENCODE10/figure/' + samples[i] + '_multiExon.pdf'
...
def plot_bar_num(hmatch, smatch):
    ...
    figure_name = './ENCODE10/figure/ENCODE10_num_multiExon.pdf'
...
def plot_bar_pre(hpre, spre):
    ...
    figure_name = './ENCODE10/figure/ENCODE10_pre_multiExon.pdf'
...
def plot_bar_adjusted_pre(hmatch, hpre, smatch, spre):
    ...
    for i in hi:
        file1 = './ENCODE10/stringtie2/' + samples[i-1] + '.hisat.me.roc-cor'
        file2 = './ENCODE10/stringtie2/' + samples[i-1] + '.hisat.me.roc-pre'
    ...
    for i in hni:
        file1 = './ENCODE10/scallop2/' + samples[i-1] + '.hisat.me.roc-cor'
        file2 = './ENCODE10/scallop2/' + samples[i-1] + '.hisat.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
    ...
    for i in mi:
        file1 = './ENCODE10/stringtie2/' + samples[i-1] + '.star.me.roc-cor'
        file2 = './ENCODE10/stringtie2/' + samples[i-1] + '.star.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
    ...
    for i in mni:
        file1 = './ENCODE10/scallop2/' + samples[i-1] + '.star.me.roc-cor'
        file2 = './ENCODE10/scallop2/' + samples[i-1] + '.star.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
    ...
    for i in hi:
        file1 = './ENCODE10/scallop/' + samples[i-1] + '.hisat.me.roc-cor'
        file2 = './ENCODE10/scallop/' + samples[i-1] + '.hisat.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
        cur_umi = hmatch[i-1][0]
        for j in range(0, len(cor)):
    ...
    for i in mi:
        file1 = './ENCODE10/scallop/' + samples[i-1] + '.star.me.roc-cor'
        file2 = './ENCODE10/scallop/' + samples[i-1] + '.star.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
        cur_umi = smatch[i-1][0]
        for j in range(0, len(cor)):
    ...
    for i in hi:
        file1 = './ENCODE10/class2/' + samples[i-1] + '.hisat.me.roc-cor'
        file2 = './ENCODE10/class2/' + samples[i-1] + '.hisat.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
        cur_umi = hmatch[i-1][0]
        for j in range(0, len(cor)):
    ...
    for i in mi:
        file1 = './ENCODE10/class2/' + samples[i-1] + '.star.me.roc-cor'
        file2 = './ENCODE10/class2/' + samples[i-1] + '.star.me.roc-pre'
        cor = np.loadtxt(file1)
        pre = np.loadtxt(file2)
        cur_umi = smatch[i-1][0]
        for j in range(0, len(cor)):
    ...
    figure_name = './ENCODE10/figure/ENCODE10_adjusted_pre_HISAT_multiExon.pdf'
    plt.savefig(figure_name, bbox_inches='tight')
    ...
    figure_name = './ENCODE10/figure/ENCODE10_adjusted_pre_STAR_multiExon.pdf'
    plt.savefig(figure_name, bbox_inches='tight')
